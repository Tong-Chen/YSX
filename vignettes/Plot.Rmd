...
```{r}
sp_upsetview(vennDiagram_data, vennFormat = 2, saveplot="1.pdf")
```
...
sp_barplot(data = bar_data, xvariable = "ID", yvariable = "Exper", color_variable = "Gene")
```
...
```{r}
histogram_test_data <- data.frame(Type = letters[1], Value = runif(80))
sp_histogram(data = histogram_test_data, yvariable = "Value", melted=T,
             group_variable = "Type", plot_type = "hist", 
             yaxis_statistics  = "count/sum(count)")
```
...
histogram_test_data <- data.frame(Type = letters[1], Value = runif(80))
sp_histogram(data = histogram_test_data, yvariable = "Value", melted=T,
             color_variable = "Type", plot_type = "line", 
             yaxis_statistics  = "density", fill_area = T)
```
...
sp_histogram(data = histogram_data, yvariable = "Value", legend_variable = "Type", 
...
sp_scatterplot(data = scatter_data, xvariable = "Gene", yvariable = "Cluster", color_variable = "Expr", size_variable = "Percent", label_variable = "Expr", manual_color_vector = c("white","blue"))
```
