...
sp_boxplot(data, melted = T, xvariable = "Cluster", yvariable = "Expr", facet="Gene", 
...
sp_histogram(data = histogram_test_data, yvariable = "Value", melted=T,
             color_variable = "Type", plot_type = "both", yaxis_statistics  = "count/sum(count)")

data = histogram_test_data
                 melted = FALSE
                         yvariable=NULL
                         color_variable=NULL
